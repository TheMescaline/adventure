...
/**
 * Utility for Caesar cipher decoding
 *
 * @author freelansam
 * {https://www.baeldung.com/java-caesar-cipher#break-java-chi_squares}
 */
@Slf4j
@UtilityClass
public class CaesarCipher {
    ...
    private final double[] ENGLISH_LETTERS_PROBABILITIES = {0.073, 0.009, 0.030, 0.044, 0.130, 0.028, 0.016, 0.035, 0.074, 0.002, 0.003, 0.035, 0.025, 0.078, 0.074, 0.027, 0.003, 0.077, 0.063, 0.093, 0.027, 0.013, 0.016, 0.005, 0.019, 0.001};
